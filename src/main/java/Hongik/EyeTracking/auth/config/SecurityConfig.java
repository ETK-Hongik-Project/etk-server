package Hongik.EyeTracking.auth.config;

import Hongik.EyeTracking.auth.jwt.JwtFilter;
import Hongik.EyeTracking.auth.jwt.TokenProvider;
import Hongik.EyeTracking.auth.jwt.exception.handler.JwtAccessDeniedHandler;
import Hongik.EyeTracking.auth.jwt.exception.handler.JwtAuthenticationEntryPointHandler;
        ...
        http
                ...
                .authorizeHttpRequests((requests) ->
                        requests
                                ...
                                .requestMatchers("/api/v1/auth/login", "/api/v1/auth/reissue", "/api/v1/join/**")
